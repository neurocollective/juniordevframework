...
const constants = {
  ...
  TABLES: {
    ...
    JOB_SEARCH_ENTITY: 'job_search_entity',
    JOB_SEARCH_ENTITY_EAV: 'job_search_entity_eav',
    JOB_SEARCH_ACTION: 'job_search_action',
    LAST_EMAIL_SCAN: 'last_email_scan',
    UNRECOGNIZED_EMAILS: 'unreconigzed_emails',
    EDGE_DATE_EMAILS: 'edge_date_emails',
  },
  ...
  EMAIL_SCAN: {
    ...
    INDEED_APPLICATION_NOTIFY_ADDRESS: '<indeedapply@indeed.com>',
  }
};
