...
describe('lib', () => {
  ...
  describe('refreshToken', () => {
    test('refreshToken works as expected', async (done) => {
  ...
  describe('convertEpochValueToGmailDate', () => {
    test('behaves as expected with app-relevant inputs', () => {
      const epoch = 1607792054855;
      const result = convertEpochValueToGmailDate(epoch);
      expect(result).toEqual('2020/12/12');
    });
  });
});
